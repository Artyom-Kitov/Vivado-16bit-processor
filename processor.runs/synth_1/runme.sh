...
HD_PWD='C:/Vivado/processor/processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Processor16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Processor16.tcl
